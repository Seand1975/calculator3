            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Container(
                  ...
                  child:  Text("$number1$operand$number2".isEmpty?"0":"$number1$operand$number2", style: const TextStyle(
                    fontSize: 48,
...
//#########################
  Color getBtnColor(value){
    ...
    [Btn.subtract,Btn.add,Btn.calculate,Btn.divide,Btn.multiply,Btn.per].
    contains(value)?Colors.orangeAccent:Colors.black87;
  }
}
